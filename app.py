...
member_put_args.add_argument("major", type=str, help="Major of the DALI member", location='form') # personal info not required
member_put_args.add_argument("minor", type=str, help="Minor of the DALI member", location='form')
member_put_args.add_argument("birthday", type=str, help="Birthday [mm-dd] of the DALI member is required", location='form')
member_put_args.add_argument("home", type=str, help="Home [city, state] of the DALI member is required", location='form')
member_put_args.add_argument("quote", type=str, help="Quote is required", location='form')
member_put_args.add_argument("favorite thing 1", type=str, help="Favorite thing 1", location='form')
member_put_args.add_argument("favorite thing 2", type=str, help="Favorite thing 2", location='form')
member_put_args.add_argument("favorite thing 3", type=str, help="Favorite thing 3", location='form')
member_put_args.add_argument("favorite dartmouth tradition", type=str, help="Favorite Dartmouth tradition", location='form')
member_put_args.add_argument("fun fact", type=str, help="Fun fact", location='form')
member_put_args.add_argument("picture", type=str, help="Picture url", location='form')
